...
class App(tkinter.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.save_marker_button = tkinter.Button(
            master=self.listbox_button_frame,
            width=20,
            text="save current marker",
