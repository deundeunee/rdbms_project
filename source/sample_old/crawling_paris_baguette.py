...
driver.find_element(By.XPATH, '//*[@id="main"]/div[1]/div[1]/div[1]/ul/li[2]/a').click() # '검색해서 찾기' 클릭
driver.find_element(By.XPATH, '//*[@id="main"]/div[1]/div[1]/div[1]/div/form/div[2]/div[1]/div/div[2]/span').click() # '도/시 선택' 클릭
driver.find_element(By.XPATH, '//*[@id="main"]/div[1]/div[1]/div[1]/div/form/div[2]/div[1]/div/div[3]/div/div[1]/ul/li[10]').click() # '서울' 클릭
...
# csv 파일 생성
with open('parisbaguette.csv','w', encoding='UTF-8', newline='') as file:
